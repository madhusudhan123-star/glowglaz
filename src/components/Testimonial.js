      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-20">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            {/* AYUSH Certification */}
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex flex-col items-center justify-center" style={{ width: "150px", height: "120px" }}>
              <img 
                src={ayush} 
                alt="Ministry of AYUSH Certification" 
                className="h-16 object-contain mb-2"
              />
              <span className="text-xs text-center text-bluegray font-medium">AYUSH Certified</span>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex flex-col items-center justify-center" style={{ width: "150px", height: "120px" }}>
              <img 
                ...
                className="h-16 object-contain mb-2"
              />
              <span className="text-xs text-center text-bluegray font-medium">Organic Ingredients</span>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex flex-col items-center justify-center" style={{ width: "150px", height: "120px" }}>
              <img 
                ...
                className="h-16 object-contain mb-2"
              />
              <span className="text-xs text-center text-bluegray font-medium">Cruelty-Free</span>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex flex-col items-center justify-center" style={{ width: "150px", height: "120px" }}>
              <img 
                ...
                className="h-16 object-contain mb-2"
              />
              <span className="text-xs text-center text-bluegray font-medium">GMP Certified</span>
            </div>
          </div>
        </div>
      </div>
